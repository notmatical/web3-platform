...
const FloorPriceStat = ({ value }: FloorPriceStatProps) => {
                    ...
                    <List sx={{ py: 0 }}>
                        <ListItem alignItems="center" disableGutters sx={{ py: 0 }}>
                            <ListItemAvatar>
                                ...
                                >
                                    <StackedLineChart fontSize="inherit" />
                                </Avatar>
                            </ListItemAvatar>
                            <ListItemText
                                sx={{
                                ...
                                primary={<Typography variant="h4">{formatPriceNumber.format(value)} SOL</Typography>}
                                secondary={
                                    <Typography
                                        variant="subtitle2"
                                        sx={{
